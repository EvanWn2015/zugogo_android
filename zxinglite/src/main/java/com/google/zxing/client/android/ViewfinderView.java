...
public final class ViewfinderView extends View implements AnimeViewCallback {
    ...
    private static final int CORNER_RECT_WIDTH = 5;  //扫描区边角的宽
    private static final int CORNER_RECT_HEIGHT = 120; //扫描区边角的高
    ...
    private final float labelTextSize = 120f;
    private final String labelText = "掃描 QRcode";
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        labelTextColor = resources.getColor(R.color.result_text);
        cornerColor = resources.getColor(R.color.light_blue);
